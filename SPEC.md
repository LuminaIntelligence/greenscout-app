...
| `entityId` | `String?` | |
| `action` | `String` | `CREATE`, `UPDATE`, `DELETE`, `SOFT_DELETE`, `LOGIN_SUCCESS`, `LOGIN_FAIL`, `LOCKOUT`, `PASSWORD_RESET`, `PASSWORD_CHANGE_FAIL`, `HANDOVER`, `GENERATE_DOCUMENT`, `RETENTION_NOTICE`, `STATUS_CHANGE`, `IMAGE_UPLOADED`, `IMAGE_REPLACED` |
| `changeSet` | `Json?` | diff |
| `ipAddress` | `String?` | |
| `userAgent` | `String?` | |
